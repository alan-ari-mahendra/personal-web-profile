...
export function ToolIconPicker({ value, onChange, onClose }: Props) {
  ...
  return (
    ...
    >
      <div className="bg-surface rounded-2xl shadow-2xl w-[520px] max-h-[80vh] flex flex-col overflow-hidden border border-line">
        {/* Header */}
        ...
        <div className="overflow-y-auto p-4 flex flex-col gap-5">
          {siFiltered.length > 0 && (
            <section>
              <p className="text-xs font-semibold text-subtle uppercase tracking-wider mb-3 font-mono">Brand</p>
          ...
          {lucideFiltered.length > 0 && (
            <section>
              <p className="text-xs font-semibold text-subtle uppercase tracking-wider mb-3 font-mono">Lucide</p>
              <div className="grid grid-cols-8 gap-1.5">
